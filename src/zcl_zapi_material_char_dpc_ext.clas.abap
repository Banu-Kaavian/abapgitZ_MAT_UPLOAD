class ZCL_ZAPI_MATERIAL_CHAR_DPC_EXT definition
  public
  inheriting from ZCL_ZAPI_MATERIAL_CHAR_DPC
  create public .
...
CLASS ZCL_ZAPI_MATERIAL_CHAR_DPC_EXT IMPLEMENTATION.
...
*--  Create Object Exception
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~get_expanded_entity.
    DATA:
      lt_deep_mat_class TYPE TABLE OF zcl_zapi_material_char_mpc=>ts_deep_mat,
      lt_char_value     TYPE TABLE OF zcl_zapi_material_char_mpc=>ts_class_char,
      lt_class_char     TYPE TABLE OF zcl_zapi_material_char_mpc=>ts_class,
      lo_exception      TYPE REF TO /iwbep/cx_mgw_busi_exception,
      ls_deep_mat_class TYPE zcl_zapi_material_char_mpc=>ts_deep_mat,
      ls_class_char     TYPE zcl_zapi_material_char_mpc=>ts_class,
      ls_char_value     TYPE zcl_zapi_material_char_mpc=>ts_class_char,
      lv_clint          TYPE clint.
