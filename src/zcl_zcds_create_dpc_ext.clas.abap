class ZCL_ZCDS_CREATE_DPC_EXT definition
  public
  inheriting from ZCL_ZCDS_CREATE_DPC
  create public .
...
CLASS ZCL_ZCDS_CREATE_DPC_EXT IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
data : ls_data type ZCL_ZCDS_CREATE_mpc_EXT=>ts_input,
...
*IMPORTING
*  es_data = ls_trno.
*if ls_trno is NOT INITIAL.
*  ls_tr-tr_no = ls_trno-tr_no.
...
*data :lv_package TYPE string VALUE 'Z_833'.
